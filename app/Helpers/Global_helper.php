...
class Global_helper
{
    ...
    public static function GenerateMobileOTP($user_info, $module_type, $otp_type, $otp, $mobile = "")
    {
        // Expire previous OTPs for the user, module, and type
        $expire_previous_otp = self::ExpireOTP($user_info->id, $module_type, $otp_type);
    ...
    {
        return Route::where('status', 1)->count();
    }

    public static function ProviderCount()
    {
        return Providers::where('status', 1)->count();
    }

    public static function CountLeads($loan_status = null)
    {
        $query = Loan_request::where('status', 1);
    ...
    public static function getServiceHelper()
    {
