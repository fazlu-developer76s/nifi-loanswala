<div id="sidebar" class="app-sidebar">
    <div class="app-sidebar-content find-link" data-scrollbar="true" data-height="100%">
        <div class="menu">
                ...
                <div class="menu-submenu">
                    ...
                    <div class="menu-item">
                        <a href="{{ route('providers') }}" class="menu-link">
                            <div class="menu-text">Providers List </div>
                        </a>
                    </div>
                    {{-- <div class="menu-item">
                        <a href="{{ route('routezip') }}" class="menu-link">
                            <div class="menu-text">Route ZipCode</div>
                        </a>
                    </div>
                    <div class="menu-item">
            ...
            @endif
            @if((Auth::user()->role_id==5 || Auth::user()->role_id==6 || Auth::user()->role_id==7) || Auth::user()->role_id == 1)
            <div class="menu-item has-sub"> <a href="javascript:;" class="menu-link">
                    <div class="menu-icon"> <i class="fas fa-list"></i> </div>
                ...
                <div class="menu-submenu">
                    ...
                    <div class="menu-item">
                        <a href="{{ route('lead.qualified') }}" class="menu-link">
                            <div class="menu-text">Approved Leads</div>
                        </a>
                    </div>
                    <div class="menu-item">
                        <a href="{{ route('lead.rejected') }}" class="menu-link">
                            <div class="menu-text">Rejected Leads</div>
                        </a>
                    </div>
                    @endif
                </div>
