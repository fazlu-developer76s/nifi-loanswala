                            ...
                            <table id="data-table-default" class="table table-striped table-bordered align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>{{ \Carbon\Carbon::parse($lead->date_of_birth)->format('d F Y') }}</td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="#" class="text-success me-2" data-bs-toggle="modal" data-bs-target="#myModal" onclick="OpenAssignModal('{{ $lead->user_id }}','{{ $lead->id }}','{{ $lead->user_id }}');">
...
<div class="modal fade" id="myModal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <form>
            ...
            <input type="hidden" id="rejected" value="1">
