                            ...
                            <div class="col-md-12">
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" value="{{ $get_lead[0]->file_no }}">
                                        </div>
                                        <div class="col-md-3">
                                    ...
                                    <div class="bordered mb-3">
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" value="{{ $get_lead[0]->customer_name }}">
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" value="{{ $get_lead[0]->shop_address }}">
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" value="{{ $get_lead[0]->home_address }}">
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="homeType" value="own" {{ $get_lead[0]->home_type==1 ? 'checked' : ' ' ; }}>
                                                    <label class="form-check-label">Own</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="homeType" value="rented" {{ $get_lead[0]->home_type==2 ? 'checked' : ' ' ; }}>
                                                    <label class="form-check-label">Rented</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" value="{{ $get_lead[0]->mobile_no }}">
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <div class="bordered mb-3">
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" value="{{ $get_lead[0]->loan_amount }}">
                                            </div>
                                            <div class="col-md-6">
                            ...
                            <table class="table">
                                <tbody>
                                    {{-- <tr>
                                        ...
                                        <td>{{ ucwords($get_lead[0]->name ?? 'N/A') }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Email:</strong></td>
                                        <td>{{ $get_lead[0]->email ?? 'N/A' }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Phone:</strong></td>
                                        <td>{{ $get_lead[0]->mobile ?? 'N/A' }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Zipcode:</strong></td>
                                        <td>{{ $get_lead[0]->zip_code ?? 'N/A' }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Loan Amount:</strong></td>
                                        <td>{{ $get_lead[0]->loan_amount ?? 'N/A' }}</td>
                                    </tr> --}}
                                    {{-- <tr>
                                        <td><strong>Reason for Loan:</strong></td>
                                        <td>{{ $get_lead[0]->reason_of_loan ?? 'N/A' }}</td>
                                    </tr> --}}
                                    {{-- <tr>
                                        <td><strong>Address:</strong></td>
                                        <td>{{ ucwords($get_lead[0]->address ?? 'N/A') }}</td>
                                    </tr> --}}
                                    <tr>
                                    ...
                                    {{-- <tr>
                                        ...
                                        <td>{{ ucwords($get_lead[0]->remark ?? 'N/A') }}</td>
                                    </tr> --}}
                                    {{-- <tr>
                                        <td><strong>Material Status:</strong></td>
                                        <td>{{ ucwords($get_lead[0]->material_status ?? 'N/A') }}</td>
                                    </tr> --}}
                                    <tr>
