                                ...
                                <div class="card-body p-0 auth-header-box" style="background: #f2f2f3;">
                                    <div class="text-center p-3">
                                        <a class="logo logo-admin">
                                            <img src="{{ asset('storage/' . $company->logo) }}" height="70"
                                    ...
                                    <form method="POST" class="my-4" action="{{ route('login') }}">
                                        ...
                                        <div class="form-floating mb-20px">
                                            <input id="mobile_no" type="mobile_no"
                                                class="form-control fs-13px h-45px  @error('mobile_no') is-invalid @enderror"
                                            ...
                                            <label for="emailAddress"
                                                class="d-flex align-items-center py-0">Mobile No.</label>
                                        </div>

                                        <div class="form-floating mb-20px">
                                            <input id="password" type="password"
                                                class="form-control fs-13px h-45px @error('password') is-invalid @enderror"
                                            ...
                                            @enderror
                                            <label for="password"
                                                class="d-flex align-items-center py-0">Password</label>
                                        </div>
