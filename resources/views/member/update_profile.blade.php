                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" placeholder="Enter Name" value="@if(empty($get_member)) {{ old('name') }} @else {{ (isset($get_member)) ? $get_member->name : '' ; }} @endif" {{ (@!empty($get_member->name)) ? 'readonly' : '' ;  }} />
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('email') is-invalid @enderror" type="email" name="email" placeholder="Enter Email" value=" @if(empty($get_member)) {{ old('email') }} @else {{ (isset($get_member)) ? $get_member->email : '' ; }} @endif" {{ (@!empty($get_member->email)) ? 'readonly' : '' ;  }} />
                                        @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('mobile_no') is-invalid @enderror" type="text" name="mobile_no" placeholder="Enter Mobile No." value="@if(empty($get_member)) {{ old('mobile_no') }} @else {{ (isset($get_member)) ? $get_member->mobile_no : '' ; }} @endif"  {{ (@!empty($get_member->mobile_no)) ? 'readonly' : '' ;  }} />
                                        @error('mobile_no')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('aadhar_no') is-invalid @enderror" type="text" name="aadhar_no" placeholder="Enter Aadhar No." value="@if(empty($get_member)) {{ old('aadhar_no') }} @else {{ (isset($get_member)) ? $get_member->aadhar_no : '' ; }} @endif"  {{ (@!empty($get_member->aadhar_no)) ? 'readonly' : '' ;  }} />
                                        @error('aadhar_no')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('pan_no') is-invalid @enderror" type="text" name="pan_no" placeholder="Enter Pan No." value="@if(empty($get_member)) {{ old('pan_no') }} @else {{ (isset($get_member)) ? $get_member->pan_no : '' ; }} @endif" {{ (@!empty($get_member->pan_no)) ? 'readonly' : '' ;  }} />
                                        @error('pan_no')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                </div>
                                @if(!empty($get_member->role_id != 1))
