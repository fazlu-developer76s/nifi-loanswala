            ...
            <div class="d-flex align-items-center mb-3">
                <div>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:;">Providers</a></li>
                        <li class="breadcrumb-item active"><i class="fa fa-arrow-back"></i> Create Providers</li>
                    </ol>
                    <h1 class="page-header mb-0">Providers</h1>
                </div>
            </div>
                        ...
                        <form action="{{ route($form_action) }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">Providers Status</label>
                                            <select class="form-control custom-select-icon @error('status') is-invalid @enderror" name="status">
                                                <option value="1" {{ old('status') == 1 ? 'selected' : '' }} {{ (isset($get_route) && $get_route->status == 1) ? 'selected' : '' ; }}>Active Providers</option>
                                                <option value="2" {{ old('status') == 2 ? 'selected' : '' }} {{ (isset($get_route) && $get_route->status == 2) ? 'selected' : '' ; }}>Inactive Providers</option>
                                            </select>
                                            @error('status')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                        ...
                        <div class="card-body">
                            <table id="data-table-default" class="table table-striped table-bordered align-middle">
                                <thead>
                                    <tr>
                                        <th width="1%"></th>
                                        {{-- <th class="text-nowrap">Providers</th> --}}
